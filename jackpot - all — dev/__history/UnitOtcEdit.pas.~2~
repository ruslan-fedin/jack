...
//Label1.caption:=DatamoduleDB.ADOTableOtc.FieldByName('Rez').Value;
Label12.caption:=DatamoduleDB.ADOTableOtc.FieldByName('KodClients').Value;
Label11.caption:=DatamoduleDB.ADOTableOtc.FieldByName('FIOSel').Value;
DateTimePicker1.DateTime:=DatamoduleDB.ADOTableOtc.FieldByName('Data').Value;
Edit2.Text:=DatamoduleDB.ADOTableOtc.FieldByName('in').Value;
Edit3.Text:=DatamoduleDB.ADOTableOtc.FieldByName('Out').Value;
