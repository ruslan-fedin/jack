...
uses
  ...
  UnitOtcEdit in 'UnitOtcEdit.pas' {OtcEdit},
  Unit1 in 'Unit1.pas' {Form1},
  UnitLicense in 'UnitLicense.pas' {License},
  func in 'func.pas';
...
begin
  ...
  Application.CreateForm(TLicense, License);
  ...
  Application.CreateForm(TOtcEdit, OtcEdit);
